...
if __name__ == "__main__":
    ...
    log_path = "/home/path/Project/adv_decorrelation/logs"
    log_name = "POS_baseline_{}.log".format(SAMPLING_METHOD)
    ...
    for tune_lambda in range(1):
        ...
        for model_repeating in trange(repeating_times):
            ...
            saved_model = model_path / "POS_baseline.pt"
