...
if __name__ == "__main__":
    ...
    parser.add_argument('--emoji_data_path', type=str, default = "/path/path/path/Dataset/deepmoji/split2")
    parser.add_argument('--hateSpeech_data_path', type=str, default = "/path/path/path/Dataset/hate_speech")
    parser.add_argument('--model_path', type=str, default = "/data/path/path/adv_decorrelation/model")
    parser.add_argument('--log_path', type=str, default = "/data/path/path/adv_decorrelation/logs")
    parser.add_argument('--log_name', type=str, default = "emoji_with_hs_log.log")
    parser.add_argument('--main_model_name', type=str, default = "deepmoji_HS_decor.pt")
    parser.add_argument('--adv_model_name', type=str, default = "deepmoji_HS_adv_decor.pt")
    parser.add_argument('--batch_size', type=int, default = 512)
    parser.add_argument('--epoch', type=int, default = 100)
    parser.add_argument('--n_hidden', type=int, default = 1)
    parser.add_argument('--dropout', type=float, default = 0.5)
    # tuning hyperparameters
    parser.add_argument('--LAMBDA_lb', type=float, default=-2)
    parser.add_argument('--LAMBDA_ub', type=float, default=+2)
    parser.add_argument('--LAMBDA_times', type=int, default=40)
    # repeating times
    ...
    emoji_data_path = args.emoji_data_path
    hateSpeech_data_path = args.hateSpeech_data_path
    
    model_path = Path(args.model_path)
    
    main_model_path = model_path / args.main_model_name
    adv_model_path = model_path / args.adv_model_name
    
    args.device = device

    # Load data
    train_data = DeepMojiDataset(args, emoji_data_path, "train", ratio=args.ratio, n = 100000)

    p_train_data = HateSpeechDataset(args, 
                                    hateSpeech_data_path, 
                                    "train", 
    ...
    dev_data = DeepMojiDataset(args, emoji_data_path, "dev")
    ...
    test_data = DeepMojiDataset(args, emoji_data_path, "test")
    ...
    for tune_lambda in trange(args.LAMBDA_times):
        ...
        for model_repeating in trange(args.repeating_times):
            ...
            for i in trange(args.epoch):
                ...
                Early stopping
                """
                if i >= 5: # and valid_loss < best_loss:
